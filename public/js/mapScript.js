              ...
              case 0:
                ...
                var app = new Vue({
                    ...
                    methods: {
                         ...
                         */
                        getStoresByName: (function () {
                            var _getStoresByName = _asyncToGenerator(
                         ...
                         */
                        getStoresOnMap: (function () {
                            var _getStoresOnMap = _asyncToGenerator(
                                /*#__PURE__*/ _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(
                                    function _callee5() {
                                        var _this = this;
                                                        ...
                                                        case 0:
                                                            ...
                                                            url.search = new URLSearchParams(
                                                                _objectSpread(
                                                                    ...
                                                                    {},
                                                                    {
                                                                        lat_ne: this.map.getBounds()
                                                                            ._northEast
                                                                            .lat,
                                                                        lng_ne: this.map.getBounds()
                                                                            ._northEast
                                                                            .lng,
                                                                        lat_sw: this.map.getBounds()
                                                                            ._southWest
                                                                            .lat,
                                                                        lng_sw: this.map.getBounds()
                                                                            ._southWest
                                                                            .lng,
                                                                    }
                                                                )
                                                        ...
                                                        case 11:
                                                            ...
                                                            _loop = function _loop(
                                                                ...
                                                                switch (
                                                                    ...
                                                                    case 1:
                                                                        icone_img =
                                                                            "img/markers/restauration.png";
                                                                        break;

                                                                    case 71:
                                                                        icone_img =
                                                                            "img/markers/alimentaire.png";
                                                                        break;
                                                                    ...
                                                                    case 191:
                                                                        icone_img =
                                                                            "img/markers/sante.png";
                                                                        break;

                                                                    case 251:
                                                                        icone_img =
                                                                            "img/markers/culture.png";
                                                                        break;

                                                                    case 311:
                                                                        icone_img =
                                                                            "img/markers/habillement.png";
                                                                        break;
                         ...
                         */
                        getStoreComments: (function () {
                            var _getStoreComments = _asyncToGenerator(
                                /*#__PURE__*/ _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(
                                    function _callee7(storeId) {
                                        var nbPage,
                                            requestOptions,
                                            url,
                                            req,
                        ...
                        refreshMapView: (function () {
                            var _refreshMapView = _asyncToGenerator(
                                /*#__PURE__*/ _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(
                                    function _callee9() {
                                        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(
                    ...
                    created: function created() {
                        ...
                        localStorage.getItem("centerMap") &&
                            (this.mapCenter = localStorage
                                .getItem("centerMap")
                                .split(",")); // get last map zoom from localStorage

                        localStorage.getItem("zoomMap") &&
                            (this.mapZoom = localStorage.getItem("zoomMap")); // mix favorite in bdd and localstorage

                        this.myFavorites = _toConsumableArray(
                            new Set(
                                [].concat(
                                    _toConsumableArray(myFavorites),
                                    _toConsumableArray(
                        ...
                        window.onunload = function () {
                            localStorage.setItem(
                                "myFavorites",
                                JSON.stringify(_this2.myFavorites)
                            );
                            if (idUser == null || !navigator.sendBeacon) return;
                            navigator.sendBeacon(
                                "".concat(
                                    _this2.baseUrl,
                                    "/api/stores/setFavorites"
                                ),
                                new Blob(
                                    [
                                        JSON.stringify({
                                                        ...
                                                        this.map.on(
                                                            ...
                                                            function () {
                                                                ...
                                                                localStorage.setItem(
                                                                    "zoomMap",
                                                                    _this3.map.getZoom()
                                                                ); // Insert les données de la map en localstorage
                                                            }
                                                        );
                    ...
                    computed: {
                        computedResultsQueryCity: function computedResultsQueryCity() {
                            return this.limitAutoCompletion
                                ? this.resultsQueryCity.slice(
                                      0,
                                      this.limitAutoCompletion
                                  )
                                : this.resultsQueryCity;
                        },
                        computedResultsQueryStore: function computedResultsQueryStore() {
                            return this.limitAutoCompletion
                                ? this.resultsQueryStore.slice(
                                      0,
                                      this.limitAutoCompletion
                                  )
                                : this.resultsQueryStore;
