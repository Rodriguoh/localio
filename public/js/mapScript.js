...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
 ...
 //Import de VueJS pour la build lors de la mise en prod
...
var app = new vue_dist_vue_esm__WEBPACK_IMPORTED_MODULE_1__.default({
            ...
            switch (_context9.prev = _context9.next) {
              case 0:
                this.map.eachLayer(function (layer) {
                  !!layer.toGeoJSON && _this2.map.removeLayer(layer);
                });
                _context9.next = 3;
  ...
  created: function created() {
    ...
    window.onunload = function () {
      localStorage.setItem("myFavorites", JSON.stringify(_this3.myFavorites));
      if (idUser == null || !navigator.sendBeacon) return;
      navigator.sendBeacon("".concat(_this3.baseUrl, "/api/stores/setFavorites"), new Blob([JSON.stringify({
        id: idUser,
        favorites: _this3.myFavorites
      })], {
          ...
          switch (_context14.prev = _context14.next) {
            ...
            case 7:
              ...
              this.map.on("moveend", function () {
                _this4.refreshMapView();

                localStorage.setItem("centerMap", [_this4.map.getCenter().lat, _this4.map.getCenter().lng]);
                localStorage.setItem("zoomMap", _this4.map.getZoom()); // Insert les données de la map en localstorage
              }); //Favorite button
